...
public class CommunicatorConfiguration {
    ...
    /**
     * Returns the Worldline Global Collect platform API endpoint URI.
     */
     ...
     * For instance, for {@link AuthorizationType#V1HMAC} this is the identifier for the secret API key.
     */
     ...
     * For instance, for {@link AuthorizationType#V1HMAC} this is the secret API key.
     */
    ...
    /**
     * Returns an identifier for the secret API key. The {@code apiKeyId} can be
    ...
    public CommunicatorConfiguration withApiKeyId(String apiKeyId) {
        return withAuthorizationId(apiKeyId);
    }

    /**
     * Returns a shared secret. The shared secret can be retrieved from the
    ...
    public void setSecretApiKey(String secretApiKey) {
        setAuthorizationSecret(secretApiKey);
    }
    ...
    public CommunicatorConfiguration withSecretApiKey(String secretApiKey) {
        return withAuthorizationSecret(secretApiKey);
    }
