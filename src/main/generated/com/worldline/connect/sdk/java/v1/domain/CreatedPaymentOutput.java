...
public class CreatedPaymentOutput {
     ...
     * <li>REJECTED PAYOUT
     * <li>CANCELLED</ul>
     * <li>SUCCESSFUL - The payment was not (yet) rejected. Use the payment statuses to determine if it was completed, see <a href="https://apireference.connect.worldline-solutions.com/s2sapi/v1/en_US/java/statuses.html">Statuses</a>. This category groups the following statuses:
