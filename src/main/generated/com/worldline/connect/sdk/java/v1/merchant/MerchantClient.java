...
package com.worldline.connect.sdk.java.v1.merchant;

import java.util.Map;

import com.worldline.connect.sdk.java.ApiResource;
import com.worldline.connect.sdk.java.v1.merchant.captures.CapturesClient;
import com.worldline.connect.sdk.java.v1.merchant.disputes.DisputesClient;
import com.worldline.connect.sdk.java.v1.merchant.files.FilesClient;
import com.worldline.connect.sdk.java.v1.merchant.hostedcheckouts.HostedcheckoutsClient;
import com.worldline.connect.sdk.java.v1.merchant.hostedmandatemanagements.HostedmandatemanagementsClient;
import com.worldline.connect.sdk.java.v1.merchant.installments.InstallmentsClient;
import com.worldline.connect.sdk.java.v1.merchant.mandates.MandatesClient;
import com.worldline.connect.sdk.java.v1.merchant.payments.PaymentsClient;
import com.worldline.connect.sdk.java.v1.merchant.payouts.PayoutsClient;
import com.worldline.connect.sdk.java.v1.merchant.productgroups.ProductgroupsClient;
import com.worldline.connect.sdk.java.v1.merchant.products.ProductsClient;
import com.worldline.connect.sdk.java.v1.merchant.refunds.RefundsClient;
import com.worldline.connect.sdk.java.v1.merchant.riskassessments.RiskassessmentsClient;
import com.worldline.connect.sdk.java.v1.merchant.services.ServicesClient;
import com.worldline.connect.sdk.java.v1.merchant.sessions.SessionsClient;
import com.worldline.connect.sdk.java.v1.merchant.tokens.TokensClient;
