...
public class MerchantAction {
     ...
     * <li>SHOW_FORM - The customer needs to be shown a form with the fields found in formFields. You can submit the data entered by the user in a <a href="https://apireference.connect.worldline-solutions.com/s2sapi/v1/en_US/java/payments/complete.html">Complete payment</a> request. Additionally:
     ...
     * <li>INITIALIZE_INAPP_THREED_SECURE_SDK - You need to initialize the 3D in app SDK using the returned parameters. The details contained in mobileThreeDSecureChallengeParameters need to be provided to the EMVco certified Mobile SDK as an initializationParameters object.
     * 
    ...
    /**
     * Populated only when the actionType of the merchantAction is SHOW_FORM. In this case, this property contains the list of fields to render, in the format that is also used in the response of <a href="https://apireference.connect.worldline-solutions.com/s2sapi/v1/en_US/java/products/get.html">Get payment product</a>.
     */
