...
import static com.worldline.connect.sdk.java.FactoryTest.API_KEY_ID;
import static com.worldline.connect.sdk.java.FactoryTest.PROPERTIES_URI;
import static com.worldline.connect.sdk.java.FactoryTest.SECRET_API_KEY;
...
class ClientTest {
    ...
    void testWithClientMetaInfo() {
        Client client1 = Factory.createClient(PROPERTIES_URI, API_KEY_ID, SECRET_API_KEY);
    ...
    class CloseIdleConnections {
        ...
        @SuppressWarnings("resource")
        void testNotPooled() {
            CommunicatorBuilder builder = Factory.createCommunicatorBuilder(PROPERTIES_URI, API_KEY_ID, SECRET_API_KEY);
